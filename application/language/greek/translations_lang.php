...
$lang['introduction_text'] = 'Κανονίστε μια μη δεσμευτική και δωρεάν συνάντηση γνωριμίας μαζί μας. Εάν έχετε συγκεκριμένες ανησυχίες, μπορείτε να μας ενημερώσετε και θα προγραμματίσουμε περισσότερα από 15 λεπτά για εσάς.';
